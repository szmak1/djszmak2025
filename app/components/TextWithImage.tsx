        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          <div className={`flex flex-col ${contentOrder}`}>
            ...
            {buttonText && buttonLink && (
              <Link
                href={buttonLink}
                className="!font-heading w-fit !bg-gradient-to-r !from-[#00ff97] !via-[#00daa8] !to-[#007ed4] !text-black px-8 py-4 rounded-lg font-bold text-lg hover:scale-105 transition-all duration-200 animate-fade-in-delay-2 shadow-lg hover:shadow-[#00ff97]/20"
              >
                {buttonText}
              </Link>
            )}
