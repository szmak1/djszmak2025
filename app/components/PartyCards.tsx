...
const parties = [
  {
    title: 'BRÖLLOPSFEST',
    description: 'Skapa en oförglömlig bröllopsfest med professionell DJ-entertainment som får alla att dansa.',
  ...
  {
    title: 'FÖRETAGSFEST',
    description: 'Uppgradera din företagsfest med professionell DJ som skapar rätt stämning för alla.',
  ...
  },
  {
    ...
    description: 'Professionell DJ-entertainment för nattklubbar som vill leverera bästa dansupplevelsen.',
    imageSrc: '/images/nattklubbsgig.webp',
    link: '/nattklubbsgig'
  },
  {
    title: 'LEDGOLV',
    description: 'Hyr LEDGOLV i Malmö och Skåne. Sätt dansgolvet i centrum och låt gästerna dansa på ett hav av ljus! Boka ditt LEDgolv idag och gör din fest oförglömlig!',
      ...
      <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-16 2xl:px-32">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="font-sans text-lg text-white/90 max-w-2xl mx-auto">
            Oavsett om du ska ha en bröllopsfest, födelsedagsfest eller företagsfest så har vi rätt DJ-entertainment för just din fest.
          </p>
        </div>
